...
```
dabs_ml_demo        <- Root directory. Both monorepo and polyrepo are supported.
│
├── dabs_ml_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
