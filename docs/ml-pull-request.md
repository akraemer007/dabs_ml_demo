...
Opening a pull request will trigger a[workflow](../.github/workflows/dabs_ml_demo-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-dabs_ml_demo-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-dabs_ml_demo-model)
